...
こういった現場では、チームで働く時、みんなが同じ方向を向いていると仕事がスムーズに進む。それがない場合、認識齟齬による細かな手戻りなどが頻繁に発生し、生産性を落とす要因となる。

こういった現場でいちソフトウェアエンジニアが仕事を進めるにあたって、チームと円滑な認識合わせを行う資料を作成できるスキルは価値が高く、強い武器になると個人的に思った。

すでに現場では「デザインドック」が浸透していると思うものの、本質を掴むために「複数人とあらかじめアイディアを共有する方法」について、平たくいくつかフレームワークを引用した上で、自分なりに有用だと感じられるスケルトンを考えてみる。
...
オリジナルの記事を読むと、この資料の立ち位置としては、エンジニア寄りの現場で、エンジニアが作成する資料である。
